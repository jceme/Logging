...
(function() {
  var AdapterMock, ConsoleAdapter, FileAdapter, Log, TeeAdapter, should,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  AdapterMock = (function(_super) {

    __extends(AdapterMock, _super);

    function AdapterMock() {
      return AdapterMock.__super__.constructor.apply(this, arguments);
    }

    "fatal error warn info debug trace".split(' ').forEach(function(key) {
      return AdapterMock.prototype["_" + key] = function(msg) {
        this.lastLevel = key;
  ...
  suite('Logging init', function() {
    test('Init without args', function() {
      Log.init();
      Log.DEFAULT_LEVEL.should.equal(Log.Level.INFO);
      return Log.DEFAULT_ADAPTER.should.be.an.instanceOf(ConsoleAdapter);
    });
    test('Init from file', function() {
    ...
    test('Init from object', function() {
      Log.init({
        adapters: [
          {
            type: "ConsoleAdapter"
    ...
    return test('Test configured log levels', function() {
      var tst;
      Log.init({
        levels: {
          "": "debug",
      ...
      tst = function(name, method, logged) {
        var log, mock;
        mock = new AdapterMock();
        log = new Log(name, null, mock);
        log[method]('msg');
        if (logged) {
          return mock.lastLevel.should.equal(method);
        } else {
          return should.not.exist(mock.lastLevel);
        }
      };
      tst('gar', 'debug', true);
      tst('gar', 'trace', false);
      ...
      tst('foo', 'warn', true);
      tst('fool', 'debug', true);
      tst('foo-bar', 'debug', true);
      tst('foo.test', 'debug', false);
      tst('foo.test', 'warn', true);
      tst('foo.bar', 'debug', false);
      return tst('foo.bar', 'info', true);
    });
  });
